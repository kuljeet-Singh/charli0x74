...
-- Raspberry Pi and Noops installation  (2 Hours)
-- Verifiaction and Other installations (2 Hours)
-- Soldering (1.5 Hours)
-- Case printing and Installation (30 mins)
-- Compiling everything into one project (1 hour)
